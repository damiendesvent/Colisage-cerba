...
$sqlQuery = 'SELECT * FROM sites WHERE '.$field.' LIKE "%'.$searchText.'%" AND '.$advancedField.' LIKE "%'.$advancedSearchText.'%" AND supprimee = '.$delete.' ORDER BY `'.$order.'` '.$isAscending.' LIMIT '.$numberLimit;
